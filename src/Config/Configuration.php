                ...
                ->arrayNode('miscellaneous')
                    ...
                    ->children()
                        ...
                        ->scalarNode('update_interval')
                            ...
                            ->isRequired()
                        ->end()
                        ->scalarNode('active_interval')
                            ->defaultValue('180 days')
                            ->info('Amount of time for players to be considered active')
                            ->isRequired()
                        ->end()
                        ...
                        ->booleanNode('demo_mode')
                            ->defaultFalse()
                            ->info('Whether the website is in demo mode (private information such as IP address or player notes will not be displayed)')
                        ->end()
                        ->scalarNode('secret')
                            ->attribute('asked', true)
