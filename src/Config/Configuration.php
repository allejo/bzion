            ...
            ->children()
                ...
                ->arrayNode('site')
                    ->children()
                        ...
                        ->arrayNode('alert')
                            ->children()
                                ->scalarNode('enabled')->defaultValue('false')->info('Whether or not a site-wide alert will be displayed')->end()
                                ->scalarNode('collapsible')->defaultValue('false')->info('Whether or not the alert can be hidden per browser')->end()
